        ...
        <div className="experience-flex">
          ...
          >
            <Card.Body>
              ...
              <Card.Text>
                ...
                <br />
                • Become PiC for a few versions of the game, this includes
                conducting task breakdown, discussions with QA and PM pre/post
                development, and do the app deployment on FE side.
                <br />
              </Card.Text>
            </Card.Body>
          </Card>
          ...
          >
            <Card.Body>
              ...
              <Card.Subtitle className="mb-2 text-muted">
                Game Programmer - Android Research &amp; Development
              </Card.Subtitle>
              <Card.Text>
                • Research new features in Android that can be implemented in
                Gameloft's games.
                <br />• Game Development using OpenGL ES.
              </Card.Text>
            </Card.Body>
          </Card>
          <Card
          ...
          >
            <Card.Body>
              ...
              <Card.Text>
                ...
                <br />• Object Oriented Programming course
              </Card.Text>
            </Card.Body>
          </Card>
        </div>
