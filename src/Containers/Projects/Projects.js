        ...
        <div className="projects-flex">
          ...
          >
            <Card.Body>
              ...
              <Card.Text>
                An e-commerce page on Shopee App dedicated for official brands.
                The project consists of 10+ people, releasing features on scrum
                basis.
              </Card.Text>
            </Card.Body>
          </Card>
          ...
          >
            <Card.Body>
              ...
              <Card.Text>
                An e-commerce page on Shopee App dedicated for supermarkets,
                where users can buy groceries. The project consists of 10+
                people, releasing features on scrum basis.
              </Card.Text>
            </Card.Body>
          </Card>
          <Card
          ...
          >
            <Card.Body>
              ...
              <Card.Text>
                An e-commerce page on Shopee App enabling admin to create custom
                drag and drop pages. The project consists of 10+ people,
                releasing features on scrum basis.
              </Card.Text>
            </Card.Body>
          </Card>
          <Card
          ...
          >
            <Card.Body>
              ...
              <Card.Text>
                A game page on Shopee App enabling users to earn coins and
                vouchers to use in Shopee e-commerce pages. The project consists
                of 10+ people, releasing features on monthly basis.
              </Card.Text>
            </Card.Body>
          </Card>
        </div>
        ...
        <div className="projects-flex">
          ...
          >
            <Card.Body>
              ...
              <Card.Text>
                A website used for applying steganography on Image, Audio, and
                Video files.
              </Card.Text>
              <Card.Link
          ...
          >
            <Card.Body>
              ...
              <Card.Subtitle className="mb-2 text-muted">
                HTML | CSS | JS | METEOR | MongoDB
              </Card.Subtitle>
              <Card.Text>
                A Software Project Management Tools for planning, using Essence
                standard.
              </Card.Text>
              <Card.Link
          ...
          >
            <Card.Body>
              ...
              <Card.Text>
                A NIM Finder project for ITB. Made for Programming Laboratory
          ...
          >
            <Card.Body>
              ...
              <Card.Text>
                A Cinema Website called Engima, simulating a real cinema
                website.
              </Card.Text>
              <Card.Link
          ...
          >
            <Card.Body>
              ...
              <Card.Text>
                A harvest-moon-like game developed using object oriented
